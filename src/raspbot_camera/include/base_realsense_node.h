...
#include <raspbot_camera/DeviceInfo.h>
#include "raspbot_camera/Metadata.h"
...
namespace realsense2_camera
{
    ...
    protected:
        ...
        bool getDeviceInfo(raspbot_camera::DeviceInfo::Request& req,
    ...
    private:
        ...
        raspbot_camera::Extrinsics rsExtrinsicsToMsg(const rs2_extrinsics& extrinsics, const std::string& frame_id) const;

        raspbot_camera::IMUInfo getImuInfo(const stream_index_pair& stream_index);
